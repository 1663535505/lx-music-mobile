...
export default forwardRef<HeaderType, HeaderProps>(({ componentId, onEnterMultiSelectMode }: HeaderProps, ref) => {
  ...
  return (
    <View style={{ ...styles.container, paddingTop: statusBarHeight, borderBottomColor: theme['c-border-background'] }}>
      ...
      <ButtonBar onEnterMultiSelectMode={onEnterMultiSelectMode} />
